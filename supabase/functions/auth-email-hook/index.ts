...
const EMAIL_SUBJECTS: Record<string, string> = {
  signup: 'Bestätige deine E-Mail – Fahrschule Metropol',
  invite: 'Du wurdest eingeladen – Fahrschule Metropol',
  magiclink: 'Dein Login-Link – Fahrschule Metropol',
  recovery: 'Passwort zurücksetzen – Fahrschule Metropol',
  email_change: 'E-Mail-Änderung bestätigen – Fahrschule Metropol',
  reauthentication: 'Dein Bestätigungscode – Fahrschule Metropol',
}
...
// Configuration
const SITE_NAME = "metropol-drive-hub"
const SENDER_DOMAIN = "notify.fahrschule-metropol.de"
const ROOT_DOMAIN = "fahrschule-metropol.de"
const FROM_DOMAIN = "fahrschule-metropol.de" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://metropol-drive-hub.lovable.app"
