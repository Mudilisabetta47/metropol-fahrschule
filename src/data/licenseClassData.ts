...
export const licenseClasses: LicenseClassData[] = [
  ...
  },
  {
    ...
    seoKeywords: "Klasse AM, Moped Führerschein, Roller Führerschein, AM ab 15, Mofa Führerschein, Roller 45 kmh, AM Hannover, AM Bremen, Moped fahren ab 15, AM Kosten, AM Dauer",
  ...
  },
  {
    ...
    seoKeywords: "Klasse BE, Anhänger Führerschein, PKW Anhänger, Wohnwagen Führerschein, Pferdeanhänger, BE Führerschein, Anhänger Hannover, Anhänger Bremen, schwerer Anhänger, BE Kosten, BE Dauer, Bootstrailer Führerschein",
  ...
  },
  {
    ...
    details: {
      ...
      duration: "Ca. 2–4 Monate",
      includes: "Theorie & Praxis, Sonderfahrten, Grundqualifikation möglich",
      exam: "Theoretische & praktische Prüfung",
    },
    prerequisites: [
      "Führerschein Klasse B (Vorbesitz)",
      "Mindestalter 21 Jahre (oder 18 mit beschleunigter Grundqualifikation)",
      "Ärztliches Gutachten & Augenärztliches Gutachten",
      "Erste-Hilfe-Kurs",
    ],
    advantages: [
      "Berufliche Perspektive als LKW-Fahrer",
      "Beschleunigte Grundqualifikation möglich",
      "Erfahrene LKW-Fahrlehrer",
      "Moderne Ausbildungsfahrzeuge",
      "Kombination mit CE möglich",
    ],
    description: [
      "Mit dem Führerschein Klasse C darfst du Kraftfahrzeuge über 3,5 t zulässiges Gesamtgewicht fahren (außer Busse). Die Klasse C ist der Einstieg in die Welt des Güterverkehrs.",
      "Für gewerbliche Fahrten benötigst du zusätzlich die Grundqualifikation nach dem Berufskraftfahrer-Qualifikations-Gesetz (BKrFQG). Diese kannst du bei uns im Rahmen der beschleunigten Grundqualifikation erwerben.",
      "Unsere erfahrenen LKW-Fahrlehrer begleiten dich von der ersten Theoriestunde bis zur bestandenen Prüfung auf modernen Ausbildungsfahrzeugen.",
    ],
    process: [
      { step: "01", title: "Anmeldung & Gutachten", text: "Melde dich an und bringe ärztliches sowie augenärztliches Gutachten mit." },
      { step: "02", title: "Theorieunterricht", text: "6 Doppelstunden Grundstoff + 10 Doppelstunden Zusatzstoff Klasse C." },
      { step: "03", title: "Praktische Ausbildung", text: "Übungsfahrten & Sonderfahrten auf dem LKW mit erfahrenen Fahrlehrern." },
      { step: "04", title: "Prüfungen", text: "Theorieprüfung + praktische Prüfung bestehen – fertig!" },
    ],
    faqs: [
      { question: "Brauche ich die Grundqualifikation?", answer: "Ja, für gewerblichen Güterverkehr ist die Grundqualifikation Pflicht. Wir bieten die beschleunigte Grundqualifikation inkl. IHK-Prüfung an." },
      { question: "Wie lange ist Klasse C gültig?", answer: "Klasse C ist befristet auf 5 Jahre und muss danach verlängert werden (ärztliches Gutachten erforderlich)." },
      { question: "Kann ich C und CE zusammen machen?", answer: "Ja, du kannst beide Klassen kombiniert ausbilden lassen – das spart Zeit und Geld." },
    ],
  },
  {
    slug: "klasse-ce",
    ...
    seoKeywords: "Klasse CE, Sattelzug Führerschein, LKW Anhänger, CE Führerschein, Gliederzug, Sattelschlepper Führerschein, CE Hannover, CE Bremen, Berufskraftfahrer CE, CE Kosten, CE Dauer",
    heroDescription: "Die Königsklasse im Güterverkehr – LKW mit Anhänger oder Sattelzüge ohne Gewichtsbeschränkung.",
    details: {
      minAge: "21 Jahre (18 mit Grundqualifikation)",
      duration: "Ca. 2–3 Monate",
      includes: "Theorie & Praxis, Sonderfahrten mit Anhänger/Sattel",
      exam: "Theoretische & praktische Prüfung",
    },
    prerequisites: [
      "Führerschein Klasse C (Vorbesitz)",
      "Ärztliches Gutachten & Augenärztliches Gutachten",
    ],
    advantages: [
      "Sattelzüge und Gliederzüge fahren",
      "Maximale berufliche Flexibilität",
      "Ausbildung auf modernen Sattelzugmaschinen",
      "Erfahrene Fahrlehrer für Großfahrzeuge",
    ],
    description: [
      "Klasse CE erlaubt dir das Führen von LKW-Kombinationen – also LKW der Klasse C mit Anhängern über 750 kg. Das umfasst Sattelzüge, Gliederzüge und alle schweren Kombinationen.",
      "CE ist die wichtigste Klasse für Berufskraftfahrer im Fernverkehr und in der Logistik. Die meisten Speditionen setzen diesen Führerschein voraus.",
      "Bei uns lernst du auf modernen Sattelzugmaschinen und wirst von erfahrenen LKW-Fahrlehrern bestens auf die Prüfung vorbereitet.",
    ],
    process: [
      { step: "01", title: "Anmeldung", text: "Du brauchst einen gültigen Klasse-C-Führerschein als Voraussetzung." },
      { step: "02", title: "Theorie", text: "6 Doppelstunden Grundstoff + 4 Doppelstunden Zusatzstoff CE." },
      { step: "03", title: "Praxis", text: "Ausbildung auf Sattelzug oder Gliederzug – inkl. Rangieren und Rückwärtsfahren." },
      { step: "04", title: "Prüfung", text: "Theorieprüfung + praktische Prüfung auf der Sattelzugmaschine." },
    ],
    faqs: [
      { question: "Was darf ich mit CE alles fahren?", answer: "Alle LKW-Kombinationen ohne Gewichtsbeschränkung – Sattelzüge, Gliederzüge und alle Anhänger." },
      { question: "Kann ich C und CE gleichzeitig machen?", answer: "Ja, eine Kombi-Ausbildung ist möglich und oft günstiger als beide Klassen einzeln." },
      { question: "Brauche ich CE für den Beruf?", answer: "Für die meisten Stellen im Fernverkehr und in der Spedition ist CE Voraussetzung." },
    ],
  },
  {
    slug: "klasse-c1",
    ...
    seoKeywords: "Klasse C1, LKW 7.5t, leichter LKW Führerschein, C1 Führerschein, Lieferfahrzeug Führerschein, C1 Hannover, C1 Bremen, Transporter Führerschein, C1 Kosten, C1 Dauer",
    ...
    advantages: [
      ...
      "Ideal für Lieferfahrzeuge & Transporter",
      "Kompaktere Ausbildung als Klasse C",
      "Gute berufliche Perspektiven",
    ],
    description: [
      "Mit Klasse C1 darfst du Kraftfahrzeuge mit einer zulässigen Gesamtmasse von 3,5 t bis 7,5 t fahren. Ideal für größere Transporter und leichte LKW.",
      "Im Gegensatz zur vollen Klasse C ist C1 bereits ab 18 Jahren möglich und die Ausbildung ist kompakter. Perfekt für Jobs im Lieferverkehr oder Handwerk.",
      "Klasse C1 ist befristet auf 5 Jahre und muss mit einem ärztlichen Gutachten verlängert werden.",
    ],
    process: [
      { step: "01", title: "Anmeldung", text: "Bringe Klasse B, ärztliches und augenärztliches Gutachten mit." },
      { step: "02", title: "Theorie", text: "6 Doppelstunden Grundstoff + 6 Doppelstunden Zusatzstoff C1." },
      { step: "03", title: "Praxis", text: "Fahrstunden auf einem Fahrzeug der Klasse C1 mit Sonderfahrten." },
      { step: "04", title: "Prüfung", text: "Theorie- und Praxisprüfung bestehen – fertig!" },
    ],
    faqs: [
      { question: "Was ist der Unterschied zwischen C1 und C?", answer: "C1 ist auf 7,5 t begrenzt, Klasse C gilt für alle Fahrzeuge über 3,5 t ohne Obergrenze." },
      { question: "Reicht C1 für einen 7,5-Tonner?", answer: "Ja, Klasse C1 berechtigt zum Fahren von Fahrzeugen bis einschließlich 7,5 t." },
      { question: "Brauche ich C1 für die Feuerwehr?", answer: "Oft ja – viele Feuerwehrfahrzeuge fallen in die Klasse C1. Einige Wehren fordern auch Klasse C." },
    ],
  },
  {
    slug: "klasse-d",
    ...
    seoKeywords: "Klasse D, Busführerschein, Bus Führerschein, D Führerschein, Busfahrer werden, Personenbeförderung, Klasse D Hannover, Klasse D Bremen, Reisebus Führerschein, Klasse D Kosten, Klasse D Dauer",
    ...
    prerequisites: [
      "Führerschein Klasse B (Vorbesitz)",
      "Mindestalter 24 Jahre (oder 21 mit beschleunigter Grundqualifikation)",
      "Ärztliches Gutachten & Augenärztliches Gutachten",
      "Erste-Hilfe-Kurs",
    ],
    advantages: [
      "Alle Busse ohne Beschränkung fahren",
      "Gefragter Beruf mit sicherer Zukunft",
      "Beschleunigte Grundqualifikation möglich",
      "Erfahrene Bus-Fahrlehrer",
    ],
    description: [
      "Mit dem Führerschein Klasse D darfst du Kraftomnibusse aller Größen fahren – vom Stadtbus bis zum Reisebus. Klasse D ist die wichtigste Voraussetzung für Busfahrer im ÖPNV und Reiseverkehr.",
      "Für den gewerblichen Personenverkehr benötigst du zusätzlich die Grundqualifikation nach BKrFQG. Diese bieten wir als beschleunigte Grundqualifikation mit IHK-Prüfung an.",
      "Der Busführerschein bietet hervorragende Berufsaussichten – Busfahrer werden überall gesucht und die Bezahlung ist attraktiv.",
    ],
    process: [
      { step: "01", title: "Anmeldung & Gutachten", text: "Ärztliches und augenärztliches Gutachten sowie Erste-Hilfe-Kurs mitbringen." },
      { step: "02", title: "Theorieunterricht", text: "6 Doppelstunden Grundstoff + 18 Doppelstunden Zusatzstoff Klasse D." },
      { step: "03", title: "Praktische Ausbildung", text: "Fahrstunden auf dem Bus – inkl. Haltestellen-Training und Sonderfahrten." },
      { step: "04", title: "Prüfungen", text: "Theorie- und Praxisprüfung bestehen – willkommen im Personenverkehr!" },
    ],
    faqs: [
      { question: "Was darf ich mit Klasse D fahren?", answer: "Alle Kraftomnibusse (Busse) ohne Beschränkung der Sitzplätze oder Fahrzeuggröße." },
      { question: "Brauche ich die Grundqualifikation?", answer: "Ja, für gewerblichen Personenverkehr ist die Grundqualifikation Pflicht." },
      { question: "Wie sind die Berufsaussichten?", answer: "Sehr gut – Busfahrer werden bundesweit dringend gesucht, sowohl im ÖPNV als auch im Reiseverkehr." },
    ],
  },
  {
    slug: "klasse-de",
    ...
    seoKeywords: "Klasse DE, Bus Anhänger Führerschein, DE Führerschein, Bus mit Anhänger, Personenbeförderung Anhänger, DE Hannover, DE Bremen, Gelenkbus Führerschein, DE Kosten, DE Dauer",
    heroDescription: "Bus mit Anhänger über 750 kg – für spezielle Einsätze im Personenverkehr und Reisebusbereich.",
    details: {
      minAge: "24 Jahre (21 mit Grundqualifikation)",
      duration: "Ca. 1–2 Monate",
      includes: "Nur Praxis, Sonderfahrten mit Anhänger",
      exam: "Praktische Prüfung",
    },
    prerequisites: [
      "Führerschein Klasse D (Vorbesitz)",
      "Ärztliches Gutachten & Augenärztliches Gutachten",
    ],
    advantages: [
      "Bus mit Anhänger fahren",
      "Erweiterte berufliche Möglichkeiten",
      "Kompakte Zusatzausbildung",
      "Keine Theorieprüfung erforderlich",
    ],
    description: [
      "Klasse DE erlaubt das Führen von Bussen der Klasse D mit Anhängern über 750 kg zulässiger Gesamtmasse.",
      "Diese Klasse wird vor allem für spezielle Einsätze im Reisebusbereich benötigt, wenn z.B. ein Gepäckanhänger mitgeführt werden soll.",
      "Die Ausbildung baut auf Klasse D auf und ist vergleichsweise kompakt – der Schwerpunkt liegt auf der Praxis.",
    ],
    process: [
      { step: "01", title: "Anmeldung", text: "Du brauchst einen gültigen Klasse-D-Führerschein als Voraussetzung." },
      { step: "02", title: "Praxis", text: "Fahrstunden mit Bus und Anhänger – inkl. An- und Abkuppeln." },
      { step: "03", title: "Sonderfahrten", text: "Pflichtfahrten mit Bus-Anhänger-Kombination." },
      { step: "04", title: "Prüfung", text: "Nur praktische Prüfung – keine Theorieprüfung erforderlich." },
    ],
    faqs: [
      { question: "Brauche ich eine Theorieprüfung für DE?", answer: "Nein, für Klasse DE ist keine Theorieprüfung erforderlich." },
      { question: "Wann brauche ich Klasse DE?", answer: "Wenn du einen Bus mit einem Anhänger über 750 kg fahren möchtest – z.B. Reisebusse mit Gepäckanhänger." },
      { question: "Ist DE im Beruf wichtig?", answer: "Es kommt auf den Einsatzbereich an. Im Reisebusverkehr kann DE ein wichtiger Zusatz sein." },
    ],
  },
  {
    slug: "klasse-b196",
  ...
  },
  {
    ...
    seoKeywords: "Klasse L, Traktor Führerschein, Zugmaschinen Führerschein, Landwirtschaft Führerschein, L Führerschein, Traktor fahren, Klasse L ab 16, Forstwirtschaft Führerschein, Klasse L Kosten, Klasse L Dauer",
