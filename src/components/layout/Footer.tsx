...
const seoLinks = [
  { label: "Fahrschule Hannover", path: "/fahrschule-hannover" },
  { label: "Fahrschule Bremen", path: "/fahrschule-bremen" },
  { label: "Fahrschule Garbsen", path: "/fahrschule-garbsen" },
  { label: "Standort Hannover", path: "/standorte/hannover" },
  { label: "Standort Bremen", path: "/standorte/bremen" },
  { label: "Standort Garbsen", path: "/standorte/garbsen" },
  { label: "Führerschein B197", path: "/fuehrerschein/klasse-b197" },
  { label: "Führerschein Klasse B", path: "/fuehrerschein/klasse-b" },
  { label: "Führerschein Klasse A", path: "/fuehrerschein/klasse-a" },
  { label: "BF17 Hannover", path: "/fuehrerschein/klasse-b" },
  { label: "Motorrad Führerschein", path: "/fuehrerschein/klasse-a" },
  { label: "Erste Hilfe Kurs", path: "/erste-hilfe" },
  { label: "Aufbauseminar", path: "/aufbauseminar" },
  { label: "LKW Führerschein", path: "/fuehrerschein/klasse-c" },
  { label: "Bus Führerschein Bremen", path: "/fuehrerschein/klasse-d" },
  { label: "Führerschein Klasse BE", path: "/fuehrerschein/klasse-be" },
  { label: "Führerschein Klasse AM", path: "/fuehrerschein/klasse-am" },
  { label: "Führerschein Klasse A1", path: "/fuehrerschein/klasse-a1" },
  { label: "Führerschein Klasse A2", path: "/fuehrerschein/klasse-a2" },
  { label: "Führerschein Preise", path: "/preise" },
  { label: "FAQ Führerschein", path: "/faq" },
];
