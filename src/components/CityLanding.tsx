...
const cityData: Record<string, CityLandingData> = {
  ...
  garbsen: {
    ...
    seoKeywords: "Fahrschule Garbsen, Führerschein Garbsen, Fahrschule Metropol Garbsen, Klasse B Garbsen, Motorradführerschein Garbsen, Intensivkurs Garbsen, Fahrschule Planetenring Garbsen, Führerschein machen Garbsen, BF17 Garbsen, Fahrschule Region Hannover, Fahrschule Garbsen günstig, Beste Fahrschule Garbsen, Fahrschule Garbsen Bewertung, Führerschein Kosten Garbsen, Fahrschule Arabisch Garbsen, Fahrschule Türkisch Garbsen, Crashkurs Führerschein Garbsen, Ferienkurs Garbsen, Begleitetes Fahren Garbsen",
