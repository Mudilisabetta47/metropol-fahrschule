      ...
      <section className="pt-32 pb-20 bg-background">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none space-y-6 text-foreground/80 text-sm leading-relaxed">
            <h2 className="text-xl font-bold text-foreground mt-8">1. Datenschutz auf einen Blick</h2>
            ...
            <h2 className="text-xl font-bold text-foreground mt-8">4. Allgemeine Hinweise und Pflichtinformationen</h2>
            ...
            <p>
              Die verantwortliche Stelle für die Datenverarbeitung auf dieser Website ist die im Impressum genannte natürliche oder juristische Person.
            </p>
            ...
            <h2 className="text-xl font-bold text-foreground mt-8">5. Datenerfassung auf dieser Website</h2>
