...
const Aufbauseminar = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEO title={t("aufbauseminar.seoTitle")} description={t("aufbauseminar.seoDesc")} canonical="https://fahrschule-metropol.de/aufbauseminar" jsonLd={[jsonLd, breadcrumbSchema]} keywords="Aufbauseminar, ASF Kurs, Aufbauseminar Fahranfänger, ASF Hannover, ASF Bremen, ASF Garbsen, Punkteabbau, Fahrerlaubnis auf Probe, Nachschulung Führerschein, Aufbauseminar Fahrschule Metropol, ASF Kosten, Führerschein Probezeit, Aufbauseminar Kosten, ASF Pflicht, Nachschulung Probezeit, ASF Seminar Hannover" />
