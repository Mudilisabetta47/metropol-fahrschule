...
const faqs = [
  ...
  { q: "An welchen Standorten ist die Fahrschule Metropol vertreten?", a: "Wir sind in Hannover (Engelbosteler Damm 1), Garbsen (Planetenring 25–27) und Bremen (Bahnhofsplatz 41) für dich da." },
];
